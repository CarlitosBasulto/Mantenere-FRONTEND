...
export const updateEstadoTrabajo = async (id: number, data: { estado: string; visitado?: boolean; hora_llegada?: string; latitud_llegada?: string; longitud_llegada?: string; motivo_rechazo?: string; rechazado_por_nombre?: string; tecnico?: string }) => {
